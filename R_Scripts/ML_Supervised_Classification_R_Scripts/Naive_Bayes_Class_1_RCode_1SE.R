...
CC_k_class_3_train_Raw_Raw<-as.data.frame(fit_naive_bayes$results)
write.csv(CC_k_class_3_train_Raw_Raw, file = "CC_k_class_1_train_Raw.csv")
...
CC_k_class_1_train_Raw<-as.data.frame(fit_naive_bayes_1$results)
write.csv(CC_k_class_1_train_Raw, file = "CC_k_class_1_train_Raw_A_1.csv")
...
test_metric_class_1_Raw_A<-as.data.frame(cf_class_1_test$byClass)
write.csv(test_metric_class_1_Raw_A,file = "test_metric_class_1_Raw_A.csv")

#Get and save confusion matrix table for testing
cf_table_class_1_test_Raw_A<-as.data.frame(cf_class_1_test$table)
cf_table_class_1_test_Raw_A<-write.csv(cf_table_class_1_test_Raw_A, 
                                             file = "cf_table_class_1_test_Raw_A.csv")
print(cf_class_1_test)
...
write.csv(check_misclas,file = "check_misclass_table_Raw.csv",row.names = FALSE)
