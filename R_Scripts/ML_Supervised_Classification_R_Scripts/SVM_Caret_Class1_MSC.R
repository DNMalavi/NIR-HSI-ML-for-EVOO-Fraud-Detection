...
CC_k_class_1_train_MSC_A<-as.data.frame(fit_svm$results)
write.csv(CC_k_class_1_train_MSC_A, file = "CC_k_class_1_train_MSC_A.csv")

##Find important variables from SVM model
impo_variable<-varImp(fit_svm)
ImptV<-(impo_variable$importance)
write.csv(ImptV, file = "important_variable_MSC_class_1.csv")
...
cf_class_1_test_MSC_A<-as.data.frame(cf_class_1_test$table)
write.csv(cf_class_1_test_MSC_A, 
          "cf_class_1_test_MSC_A.csv")

##Save the testing metrics
cf_class_1_test_metrics_MSC_A<-as.data.frame(cf_class_1_test$byClass)
write.csv(cf_class_1_test_metrics_MSC_A,file = "cf_class_1_test_metrics_MSC_A.csv")
#-------------------------END---------------------------------------------------