...
CC_k_class_2_train_SNV_SG_1D_A<-as.data.frame(fit_svm$results)
write.csv(CC_k_class_2_train_SNV_SG_1D_A, file = "CC_k_class_2_train_SNV_SG_1D_A.csv")

##Find important variables from SVM model
impo_variable<-varImp(fit_svm)
ImptV<-(impo_variable$importance)
write.csv(ImptV, file = "important_variable_SNV_SG_1D_class_2.csv")
...
cf_class_2_test_SNV_SG_1D_A<-as.data.frame(cf_class_2_test$table)
write.csv(cf_class_2_test_SNV_SG_1D_A, 
          "cf_class_2_test_SNV_SG_1D_A.csv")

##Save the testing metrics
cf_class_2_test_metrics_SNV_SG_1D_A<-as.data.frame(cf_class_2_test$byClass)
write.csv(cf_class_2_test_metrics_SNV_SG_1D_A,file = "cf_class_2_test_metrics_SNV_SG_1D_A.csv")
#-----------------------THE END-------------------------------------------------
